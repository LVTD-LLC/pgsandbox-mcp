...
- Documented measured template and large-suite tradeoffs, including the Rowset
  frontend-build prerequisite and when fresh-sandbox partitioning is worthwhile.
